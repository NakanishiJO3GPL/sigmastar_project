...
#define VENC_CUST_MAP_NUM      (3)
#define VENC_MAX_SAD_RANGE_NUM (16)

#define VENC_MAX_SMART_VIDEO_CODING_AREA_NUM (16)
...
typedef struct MI_VENC_SmartVideoCoding_s
{
    MI_BOOL        bEnable;
    MI_U8          u8StrengthI;
    MI_U8          u8StrengthP;
    MI_U32         u32RectCount;
    MI_VENC_Rect_t stRect[VENC_MAX_SMART_VIDEO_CODING_AREA_NUM];
} MI_VENC_SmartVideoCoding_t;
