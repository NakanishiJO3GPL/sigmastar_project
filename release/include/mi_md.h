...
int32_t MI_MD_Run64(MD_HANDLE handle, const MI_MD_IMG64_t* pImage);
...
MI_MD_RET MI_MD_ResetBgImage(MD_HANDLE handle, const MI_MD_IMG64_t* pImage);

MI_MD_RET MI_MD_ComputeImageSAD(MD_HANDLE handle, const MI_MD_IMG_t* pImage, MDSAD_DATA_t *sad_data);
MI_MD_RET MI_MD_ComputeImageSAD64(MD_HANDLE handle, const MI_MD_IMG64_t* pImage, MDSAD_DATA_t *sad_data);
...
MI_MD_RET MI_MD_LightSwitchDetect64(MD_HANDLE handle, const MI_MD_IMG64_t* pImage, MDOBJ_DATA_t *ccobj);
