...
typedef enum
{
	...
	ALGO_AEC_RET_INVALID_RECURSIVE_RATIO		=0x10000411,
	ALGO_AEC_RET_API_CONFLICT				=0x10000412,
	ALGO_AEC_RET_INVALID_CALLING			=0x10000413,
}ALGO_AEC_RET;
...
ALGO_AEC_RET IaaAec_ADF_Run(AEC_HANDLE handle, short* pss_aduio_near_end, short* pss_aduio_far_end);
ALGO_AEC_RET IaaAec_NLP_Run(AEC_HANDLE handle, short* pss_aduio_near_end);
