...
#define ALGO_SSL_RET_INVALID_VAD_LEVEL		0x20000406
#define ALGO_SSL_RET_INVALID_FREQRANGE		0x20000407
#define ALGO_SSL_RET_INVALID_SSL_RESOLUTION	0x20000408

#define MAX_MIC_CHANNEL_NUM	(4)
...
typedef enum{
	IAA_SSL_UNIFORM_LINEAR_ARRAY = 0,
	IAA_SSL_UNIFORM_CIRCULAR_ARRAY,
}SslMicGeometry_e;
