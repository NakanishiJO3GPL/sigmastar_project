...
typedef struct MI_RGN_LineChnPortParam_s
{
    MI_RGN_Point_t stPointFrom;
    MI_RGN_Point_t stPointTo;
    MI_U32         u32LineWidth;

    MI_U32  u32Color;
    MI_BOOL bHollow;
    MI_U8   u8BorderThickness;
} MI_RGN_LineChnPortParam_t;
...
typedef struct MI_RGN_ChnPortParam_s
{
    ...
    union
    {
        ...
        MI_RGN_LineChnPortParam_t  stLineChnPort;
    };
