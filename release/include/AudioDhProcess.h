...
DH_HANDLE IaaDh_Reset(char* working_buffer_address, AudioDhInit *eq_init);
ALGO_DH_RET IaaDh_GetConfig(DH_HANDLE handle, AudioDhInit *eq_init, AudioDhConfig *eq_config);
