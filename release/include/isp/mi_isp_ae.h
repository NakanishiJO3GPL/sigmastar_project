...
extern "C"
{
    ...
    MI_S32 MI_ISP_AE_QueryVeryShortExpoInfo(MI_U32 DevId, MI_U32 Channel, MI_ISP_AE_VeryShortExpoInfoType_t *data);
    ...
    MI_S32 MI_ISP_AE_SetPlainVeryShortExpoTable(MI_U32 DevId, MI_U32 Channel, MI_ISP_AE_ExpoTableType_t *data);
    MI_S32 MI_ISP_AE_GetPlainVeryShortExpoTable(MI_U32 DevId, MI_U32 Channel, MI_ISP_AE_ExpoTableType_t *data);
    ...
    MI_S32 MI_ISP_AE_SetStabilizerExCall(MI_U32 DevId, MI_U32 Channel, MI_U8 *param_ary[], MI_U8 param_num);
    ...
    MI_S32 MI_ISP_AE_SetHDRMLDynamicRatioCall(MI_U32 DevId, MI_U32 Channel, MI_U8 *param_ary[], MI_U8 param_num);
    MI_S32 MI_ISP_AE_SetHDRSMDynamicRatioCall(MI_U32 DevId, MI_U32 Channel, MI_U8 *param_ary[], MI_U8 param_num);
    MI_S32 MI_ISP_AE_SetExpoTableModeCall(MI_U32 DevId, MI_U32 Channel, MI_U8 *param_ary[], MI_U8 param_num);
    /************************************* LOAD API END  *************************************/
