...
{
    AE_STATS_PP_TYPE_MERGE_AVG = 0,
    AE_STATS_PP_TYPE_SEP,
    AE_STATS_PP_TYPE_MAX,
} CusAeStatsPostProcessing_e;

typedef enum __attribute__ ((aligned (1)))
{
    AWB_STATS_PP_TYPE_MERGE_LINE_INTERLEAVE = 0,
    AWB_STATS_PP_TYPE_SEP,
    AWB_STATS_PP_TYPE_MAX,
} CusAwbStatsPostProcessing_e;

typedef enum __attribute__ ((aligned (1)))
{
    AE_OP_MODE_NORMAL = 0,
    AE_OP_MODE_AOV_SENSOR_AE,
} CusAeOpMode_e;
...
typedef struct
{
    ...
    MI_U32 u32SensorDelayValidStatsFrame;
...
{
    MI_U32 Size;                            /**< struct size*/
    void   *hist1;                          /**< HW statistic histogram 1 - long*/
    void   *hist2;                          /**< HW statistic histogram 2 - long*/
    MI_U32 AvgBlkX;                         /**< HW statistics average block number*/
    MI_U32 AvgBlkY;                         /**< HW statistics average block number*/
...
typedef struct
{
    ...
    MI_S32 i4BVx16384;                      /**< Bv * 16384 in APEX system, EV = Av + Tv = Sv + Bv */
...
typedef struct
{
    ...
    MI_U32 i4BVx16384;                      /**< From AE output, Bv * 16384 in APEX system, EV = Av + Tv = Sv + Bv */
    ...
    MI_U8 nGroupSyncChNum;
    CusSync3AChanMap stSync3AChMap[8];
    MI_U32 nAwbStatsPostProcessing;
...
// --------------------------------------------
#ifndef ENABLE_ISP_PDAF
// #define ENABLE_ISP_PDAF // enable_isp_pdaf
#endif
...
typedef struct
{
    PDAF_STATS_PARAM_t stParaAPI[1];
} CusPdafStats_t;
// --------------------------------------------
...
typedef enum __attribute__ ((aligned (1)))
{
    AF_SOURCE_BINING_3DNR = 0,
    AF_SOURCE_FROM_SE_OBC_BF_HDR = 2,
    AF_SOURCE_FROM_SE_WBG_BF_HDR = 3,
    AF_SOURCE_FROM_SE_ALSC_AF_HDR = 4,
    AF_SOURCE_FROM_SE_WBG_AF_HDR = 5,
} CusAFSource_e;
...
typedef enum __attribute__ ((aligned (1)))
{
    HISTO_SOURCE_FROM_SE_OBC_BF_HDR = 2,
    HISTO_SOURCE_FROM_SE_WBG_BF_HDR = 3,
    HISTO_SOURCE_FROM_SE_ALSC_AF_HDR = 4,
    HISTO_SOURCE_FROM_SE_WBG_AF_HDR = 5,
} CusHISTOSource_e;

typedef enum __attribute__ ((aligned (1)))
{
    AWB_SOURCE_FROM_SE_OBC_BF_HDR = 2,
    AWB_SOURCE_FROM_SE_WBG_BF_HDR = 3,
    AWB_SOURCE_FROM_SE_ALSC_AF_HDR = 4,
    AWB_SOURCE_FROM_SE_WBG_AF_HDR = 5,
} CusAWBSource_e;

typedef struct
{
    CusAWBSource_e eAwbSrcSE;
    CusAWBSource_e eAwbSrcME;
    CusAWBSource_e eAwbSrcLE;
} CusAWBSourceExposure_t;
...
typedef enum
{
    ...
    eRawStoreNode_ISPOUT_CROP = 8,
    eRawStoreNode_ISP1OUT = 9,
    eRawStoreNode_WDMA_PIPE = 10,
    eRawStoreNode_EXT_WDMA_HDROUT = 11,
    eRawStoreNode_EXT_WDMA_BF_3DNR = 12,
    eRawStoreNode_EXT_WDMA_BF_WDR = 13,
    eRawStoreNode_EXT_WDMA_BF_RGB2YUV = 14,
    eRawStoreNode_EXT_DMA_PATH0 = 15,
    eRawStoreNode_WDMA_NONE = 16             /* No WDMA420 output */
