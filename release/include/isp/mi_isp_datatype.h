...
#define VERSIONPARA_DATA_SIZE (64)
    ...
    typedef enum
    {
        E_MI_ISP_AE_STATS_PP_TYPE_MERGE_AVG = 0,
        E_MI_ISP_AE_STATS_PP_TYPE_SEP,
        E_MI_ISP_AE_STATS_PP_TYPE_MAX,
    } MI_ISP_AeStatsPostProcessing_e;

    typedef enum
    {
        E_MI_ISP_AWB_STATS_PP_TYPE_MERGE_LINE_INTERLEAVE = 0,
        E_MI_ISP_AWB_STATS_PP_TYPE_SEP,
        E_MI_ISP_AWB_STATS_PP_TYPE_MAX,
    } MI_ISP_AwbStatsPostProcessing_e;
