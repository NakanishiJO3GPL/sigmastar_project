...
#define ID_CHIP_IFADO                   (0x6d65032c)
...
#define ID_API_ISP_IQ_HSVBYISO                      ( ID_API_ISP_IQ_BASE  + 82 ) // 82. 4178
...
#define ID_API_ISP_AWB_QUERY_STATIS_INFO            ( ID_API_ISP_AWB_BASE + 106 )// 106.6250
...
#define ID_API_VIDEO_RATE_CONTROL_PARAM             ( ID_API_VIDEO_ENCODE_BASE  + 3 ) // 3. 12548
#define ID_API_VENC_ALG_PARAM                       ( ID_API_VIDEO_ENCODE_BASE  + 4 ) // 4. 12549
#define ID_API_VIDEO_DEVICE_ID                      ( ID_API_VIDEO_ENCODE_BASE  + 5 ) // 5. 12550
#define ID_API_VENC_INFO_LOG                        ( ID_API_VIDEO_ENCODE_BASE  + 6 ) // 6. 12551
#define ID_API_CTX_INFO_LOG                         ( ID_API_VIDEO_ENCODE_BASE  + 7 ) // 7. 12552
