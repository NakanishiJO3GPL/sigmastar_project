...
extern "C"
{
    ...
    MI_S32 MI_ISP_IQ_SetHsvByIso(MI_U32 DevId, MI_U32 Channel, MI_ISP_IQ_HsvByIsoType_t *data);
    MI_S32 MI_ISP_IQ_GetHsvByIso(MI_U32 DevId, MI_U32 Channel, MI_ISP_IQ_HsvByIsoType_t *data);
    ...
    MI_S32 MI_ISP_IQ_SetHsvByIsoCall(MI_U32 DevId, MI_U32 Channel, MI_U8 *param_ary[], MI_U8 param_num);
