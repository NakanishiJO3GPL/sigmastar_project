...
codesize_statistics: codesize_blueprint
	...
	@cp $(PROJ_ROOT)/release/chip/$(CHIP)/$(PRODUCT)/common/$(TOOLCHAIN)/$(TOOLCHAIN_VERSION)/release/modules/$(KERNEL_VERSION)/mi_*.ko $(PROJ_ROOT)/image/codesize/$(CODESIZE_DEFCONFIG)/CODESIZE_TOTAL
