...
def main():
    ...
    if (flash_type == "nor"):
        block_size = 65536
    subblock_per_block = int(block_size / subblock_size);
    ...
    for entry in entries:
        ...
        file_subblock = int(file_len / (subblock_size - subblock_reserved_size))
    ...
    file_block_cnt += int(subblock_cnt / subblock_per_block)
