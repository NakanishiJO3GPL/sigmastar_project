...
ramdisk_$(FLASH_TYPE)_gz_script:
	...
	@if [ "$(DUAL_OS)" = "on" ]; then \
		echo $(LOAD_CMD) $(DOWNLOADADDR) initramfs.gz >> $(SCRIPTDIR)/[[ramdisk.$(FILE_TYPE); \
...
rtos_tftp_script:
	...
	@echo tftp 0x20e00000 initramfs.gz >> $(SCRIPTDIR)/[[rtos_tftp.es
...
%_$(FLASH_TYPE)_ramfs_script:
	...
	@$(call gen_setenv_cmd,rootfs_file_size initrd_block initrd_comp, \
