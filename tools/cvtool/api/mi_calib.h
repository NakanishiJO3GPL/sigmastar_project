...
MI_CALIB_RetCode_e MI_CALIB_Calibration(MI_CALIB_Handle_t algHandle, MI_CALIB_Conf *pMI_Conf, MI_CALIB_BufBlock_t *pstInJsonBuf,
    MI_CALIB_BufBlock_t *pstOutJsonBuf, MI_CALIB_BufBlock_t *pcalibErrBuf); 
