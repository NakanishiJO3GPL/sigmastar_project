...
## [8.0.2.0] - 2025 - 12 - 02
### Fixed
- [NE] Fixed wrong OBC calculation while 8.0.0.0.

## [8.0.1.0] - 2025 - 10 - 29
### Add 
- [NE] Support AIBNR mode calibration.

### Changed
- [NE] Set gch_mode_sel as gray mode for CHIP ID after IFADO.

### Fixed
- [AIBNR] Fix Quantilize to float bug while shift large than 32.

## [8.0.0.0] - 2025 - 09 - 02 !!!API CHANGE!!!
### Add 
- [NE] Plugin API add ISP gain input.
- [NE] Add DCG mode.

## [7.0.0.0] - 2025 - 08 - 21 !!!API CHANGE!!!
### Changed 
- [AIBNR] Plugin API Change to support set default pregain table via sensor Again.

## [6.0.1.0] - 2025 - 05 - 31 
### Add 
- [ALL] Start to support chip ID iFliegen/iHalo/mHera

## [6.0.0.0] - 2025 - 05 - 29 !!!API CHANGE!!!
### Changed 
- [AIBNR] Plugin API Change to support set pregain  node by user.

## [5.0.1.0] - 2025 - 05 - 14
### Fixed 
- [ALSC] Fixed wrong file path while split mode with x64 compile

## [5.0.0.0] - 2025 - 05 - 06 !!!API CHANGE!!!
### Add 
- [AIBNR] Add API to load AIBNR cali data and get Ak Bk As Bs and KSCurveNode

### Changed 
- [ALSC] Plugin API Change to support different ValueRangeHandlingMode
- [ALSC] Plugin API Change to support split mode.

## [4.0.1.0] - 2025 - 04 - 17
### Fixed
- [ALL] Fixed wrong calibration data version for new chips

## [4.0.0.0] - 2025 - 03 - 31 !!!API CHANGE!!!
### Changed 
- [AIBNR] API Change to support multi range AIBNR calibration.
- [AIBNR] API Change to support validation of AIBNR calibration.
- [AIBNR] InitFile not supported anymore.
- [ALSC] Add ValueRangeHandlingMode/SplitOverlap/ConcateMode to plugin API.

## [3.1.2.0] - 2025 - 03 - 04
### Add
- [NE] Load node, pregain, totalgain if "private_data.txt" is exists, and add them to "aibnr_cali.data"
### Changed
- [ALSC_SPLIT_MODE] Fix ConcatFileMode error, keep original 2 file and cancat them to "alsc_cali_concat.bin"
